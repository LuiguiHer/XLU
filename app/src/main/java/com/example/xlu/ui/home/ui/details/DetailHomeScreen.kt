...
@Composable
fun DetailHomeScreen(movie: BestMovies, navController: NavController, viewModel: DetailHomeViewModel){
    Column(modifier = Modifier
        .fillMaxSize()) {
        ButtonBackDetailHome(movie) {viewModel.onBackSelected(navController)}
        DetailsHome(movie,viewModel)
    }
}
@Composable
fun DetailsHome(movie:BestMovies, viewModel: DetailHomeViewModel){
...
@Composable
fun ButtonBackDetailHome(movie:BestMovies,onBackSelected:()->Unit ) {
